...
const PHASES = [
  { name: "Inhale 1", to: 1.15, duration: 2000 },
  { name: "Hold", to: 1.15, duration: 2000 },
  { name: "Inhale 2", to: 1.3, duration: 2000 },
  { name: "Hold", to: 1.3, duration: 2000 },
  { name: "Exhale", to: 1, duration: 4000 },
] as const;

export const DiamondBreathing: React.FC<BreathingProps> = ({
  size = 120,
  color = "skyblue",
  onCycleEnd,
}) => {
